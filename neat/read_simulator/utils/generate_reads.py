...
#
# from ...models import make_qual_score_list, apply_markov_chain, process_bam_file, load_markov_predictions
#
# __all__ = [
#     'generate_reads',
#     'cover_dataset',
...
#     ):
#         pickle_file = "markov_predictions.pkl"
#
#         process_bam_file(pickle_file)
#         markov_preds_df = load_markov_predictions(pickle_file)
#
...
def generate_reads(reference: SeqRecord,
    ...
    with (
        ...
        process_bam_file("/Users/keshavgandhi/PycharmProjects/NEAT/markov.pickle")
        load_markov_predictions("/Users/keshavgandhi/PycharmProjects/NEAT/markov.pickle")
