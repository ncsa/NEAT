...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument('-b', '--bed', type=str, required=False, default=None, help="Bed file with regions to use in the model")
        parser.add_argument('--outcounts', type=str, required=False, default=None, help="Path to trinucleotide counts file for reference. Note, this"
                                                        "file will not be used if a bed file is also used.")
        
        parser.add_argument('--show-trinuc', action='store_true', required=False, default=False, help='Shows trinucleotide counts, for reference')
        parser.add_argument('--save_trinuc', action='store_true', required=False, default=False,
                            help='Saves trinucleotide counts to a file called <out>.counts')
        parser.add_argument('--human_sample', action='store_true', required=False, default=False,
                            help='Only use numbered chroms, X, Y, and MT. Omit this flag to include all chroms in reference.')
        parser.add_argument('--skip_common', action='store_true', required=False, default=False,
                            help="Includes a list of common variants, if you want to visualize common variants with plot_mut_model.py.")
