...
### rneat
We would like to introduce a new tool, called `rneat`, a rust implementation of NEAT, based largely on the original NEAT 2.1 codebase, is faster and more memory efficient than NEAT 4. Check our repo here: <a href=https://github.com/ncsa/rusty-neat/ target="_blank">https://github.com/ncsa/rusty-neat</a>, where you can navigate to releases to download the latest binary, or find it on <a href=https://zenodo.org/records/20577688>Zenodo</a>. In addition to being able to do everything NEAT can do, `rneat` resurrects GC bias from the original NEAT 2 and implements a cancer model, including complex SVs, cancer purity, and other features. Check out `rneat` and let us know what you think!
