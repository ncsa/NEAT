...
- [**2**] NEAT 4.3's read generation algorithm eliminates artificial gaps in the output and now facilitates parallelization.


- [**3**] Variants can be incorporated into NEAT-generated reads via user-inputted VCF files. NEAT 2.0 reads only minimal data of the variant, but this has been expanded in NEAT 4.3.
